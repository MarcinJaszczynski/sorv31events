...
return new class extends Migration {
    public function up()
    {
        Schema::table('event_template_event_template_program_point', function (Blueprint $table) {
            if (!Schema::hasColumn('event_template_event_template_program_point', 'show_title_style')) {
                $table->boolean('show_title_style')->default(true)->nullable()->after('active');
            }
            if (!Schema::hasColumn('event_template_event_template_program_point', 'show_description')) {
