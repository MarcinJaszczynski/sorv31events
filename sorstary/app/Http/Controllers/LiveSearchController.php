        ...
        if(!empty($request['order'])){
            switch($request['order']){
                ...
                case 'nameDesc':
                    ...
                    break;
                case 'startAsc':
                    $q->orderBy('eventStartDateTime', 'asc');
                    break;
                case 'startDesc':
                    $q->orderBy('eventEndDateTime', 'desc');
                    break;
                case 'durAsc':
                    $q->orderBy('duration', 'asc');
                    break;
                case 'durDesc':
                    $q->orderBy('duration', 'desc');
                    break;
                case 'createAsc':
                ...
                case 'createDesc':
                    ...
                    break;
                case 'statusAsc':
                    $q->orderBy('eventStatus', 'asc');
                    break;
                case 'statusDesc':
                    $q->orderBy('eventStatus', 'desc');
                    break;
                case 'statusChangeAsc':
                    $q->orderBy('statusChangeDatetime', 'ASC');
                    break;
                case 'statusChangeDesc':
                    $q->orderBy('statusChangeDatetime', 'desc');
                    break;
                default:
                    $q->orderBy('eventStartDateTime', 'asc');
