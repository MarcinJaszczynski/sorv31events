...
class Contractor extends Model
{
    ...
    {
        return $this->belongsToMany(ContractorType::class, 'contractor_contractortype', 'contractor_id', 'contractor_type_id');
    }
    ...
    public function contractorevents(){
        return $this->belongsToMany(Event::class, 'event_contractors');
    }
}
