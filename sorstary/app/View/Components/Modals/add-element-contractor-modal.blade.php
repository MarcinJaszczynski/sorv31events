...
<div class="modal fade" id="addElementContractorModal" tabindex="-1" role="dialog" aria-labelledby="addElementContractorModal" aria-hidden="true">
             ...
             <form action="/createElementContractor" method="POST">
                @csrf            
                    ...
                    <div class="modal-body">
                        ...
                        {{-- <input type='hidden' name='contractortype_id' value=''>                     --}}
