                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                @foreach($eventcontractors->where('contractortype_id', 5)->unique('contractor_id') as $eventcontractor)
                                            ...
                                            <div><button type="button" class="btn btn-link p-0 hotel_note_edit" data-eventcotroler-id='{{$eventcontractor->id}}' data-toggle="modal" data-target="#editElementContractorModal">Ustalenia:</button> {!! $eventcontractor->desc !!}</div>
                                ...
                                <div class="card-text">
                                    <div class="input-group mb-3">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <textarea id="editEventNote" name="eventEndDescription" rows="6" class="form-control summernoteeditor">
