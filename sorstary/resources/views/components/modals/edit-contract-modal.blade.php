...
<div class="modal fade" id="contractModal" role="dialog" aria-labelledby="contractLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            {{ Form::open(array('url' => '/reports/contractPdf', 'method' => 'post', 'target'=>'_blank')) }}
            @csrf
            ...
            <div class="modal-body">
                ...
                @endphp
                    @foreach($event->eventContractor as $contractor)
                        ...
                        @php
                        $hotelCount++
                        @endphp<b>{!!$contractor->contractor->name!!}, </b>&#10{!!$contractor->contractor->street!!}, {!!$contractor->contractor->city!!}, &#10tel.: {!!$contractor->contractor->phone!!}, email: {!!$contractor->contractor->email!!}&#10<br>
                    @endif
                    @endforeach
                    @if($hotelCount=0)
