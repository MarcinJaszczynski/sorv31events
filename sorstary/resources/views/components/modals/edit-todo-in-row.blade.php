                ...
                <div class="row">
                            ...
                            <div class="col-sm-8">
                                <select name="status_id" id="status_id">
                                    ...
                                    @foreach($todoStatuses as $todoStatus){
                                        @if($todoStatus_id !== $todo->status_id)
                                            <option value="{{$todoStatus_id}}">{{ $todoStatus_name }}</option>
                                        @endif
                                    }
                                    @end
                                </select>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-row">
                            ...
                            <textarea class="summernoteeditor" name="description">{!! $todo->description !!}</textarea>
                            </div>   
                        </div>
                    </div>
                    </div>
