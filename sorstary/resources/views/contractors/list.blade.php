    ...
    function contractorsTable(data){
        ...
        if (data.contractors.length<=0){
            ...
            <tr>
                ...
                let typeCell = headerRow.insertCell();
                typeCell.innerText='Rodzaj';
            ...
            data.contractors.forEach(contractor=>{
                ...
                let contractorTypeCell = newRow.insertCell();
                // let contractorActionsCell = newRow.insertCell(); 
                let types = '';
                for(let i=0; i<contractor.type.length; i++){
                types = types + contractor.type[i].name + '<br> ';
                }



                // for (let i=0; i<contractor.type.lengt; i++){
                //     // types = types + contractor.type[i].name + '<br>'
                //     // console.log(contractors.name)
                // }                
                contractorNameCell.innerHTML = contractorNameLink + ' - ' + '<br>' + contractorFirstname + ' ' + contractorSurname;
                ...
                contractorTypeCell.innerHTML = types;
