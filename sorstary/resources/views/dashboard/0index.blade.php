      ...
      <div class="col-lg-3 col-6">
        <div class="small-box bg-danger">
          <div class="inner">
            <h3>  
              @php
                echo DB::table('todos')->where('executor_id', Auth::user()->id)->where('urgent', '1')->count();  
              @endphp
            </h3>
            <p>Pilne zadania</p>
          </div>
          ...
          <a href="/todo?executor={{ Auth::user()->id }}&urgent=1" class="small-box-footer">więcej <i class="fas fa-arrow-circle-right"></i></a>
        </div>
      </div>
