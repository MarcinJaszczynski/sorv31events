                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="hidden" name="eventStatus" value="Zapytanie">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name='orderNote' class='form-control editEventNote'></textarea>
...
document.querySelector('#eventStartDateTime').value = currentDateTime();
document.querySelector('#eventEndDateTime').value = currentDateTime();
</script>
