    ...
    function eventsTable(data){
        ...
        if (data.events.length<=0){
            ...
            data.events.forEach(event=>{
                ...
                eventNameCell.innerHTML = eventName + ' (osób: ' + event.eventTotalQty +')' + '<br>' + '(' +  event.eventOfficeId +')' +'<br>' + purchaserStr;
    ...
    function contractorsData(event, id){
        ...
        event.eventcontractors.forEach(contractor=>{
                    if(contractor.pivot.contractortype_id === id){
                        ...
                        contractorsStr = contractorsStr + '<span class="font-weight-bold text-muted"> ' + name + ',</span>' 
